...
class Organization(models.Model):
    ...
    mnemo_org_name = models.Charfield(max_lenght = 200, verbose_name = "МнемоКод")
    ...
    legal_address = models.Charfield(max_lenght = 400, verbose_name = "Юридический адрес")
    post_address = models.Charfield(max_lenght = 400, verbose_name = "Почтовый адрес")
    actual_address = models.Charfield(max_lenght = 400, verbose_name = "Фактический адрес")
